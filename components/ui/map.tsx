...
function MapMarker({
  ...
  // Wire up event listeners; handlers read the latest callbacks via the ref
  useEffect(() => {
  ...
  // Sync marker properties with props
  useEffect(() => {
    if (
    ...
    >
      {closeButton && (
        <button
          type="button"
          onClick={handleClose}
          className="absolute top-1 right-1 z-10 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
