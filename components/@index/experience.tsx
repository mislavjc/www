...
import { codeContent } from 'lib/site-content';
...
export const Experience = () => {
  return (
    ...
    >
      ...
      <p className="mb-4 max-w-xl text-stone-600">{codeContent.origin}</p>

      <p className="mb-12 max-w-xl text-stone-600">{codeContent.now}</p>
